...
# Ej 1: Escribí un programa que verifique si un string tiene al menos un carácter permitido.
...
# Ej 6:  Escribí un programa que dada una lista de strings verifique si se encuentran en una frase dada
...
# Ej 7:  Realizá un programa que encuentre un string que contenga solamente letras minúsculas, mayúsculas, espacios y números.
